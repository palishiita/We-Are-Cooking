...
ingredients = [
    ...
    {"id": "1bb34aa2-e426-46e9-a518-d44fb6b419e5", "name": "Basil", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "5c7fc23a-188d-4a53-9325-21ccef62d808", "name": "Onion", "units": ["l", "ml", "tsp", "tbsp", "cup"]},
    {"id": "2aa17ede-a10e-407f-8feb-41d0cc54dc7a", "name": "Carrot", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "b5b94f34-17ee-4324-b5aa-377619ec67fc", "name": "Potato", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "8078633e-f337-40ad-828f-f545c3fb9503", "name": "Salt", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "b463be3b-0e4f-4256-8702-6af84474bb96", "name": "Black Pepper", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "8cf37f89-0b9b-409f-9c1c-e0db03666966", "name": "Egg", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "83d8df76-37b0-43f9-9f3b-dde96f2ab8c8","name": "Milk", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "7698a6b3-c0a2-48aa-af8c-be363a26023e","name": "Cheddar Cheese", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "f383e75c-cee2-4445-88de-922311c86037","name": "Butter", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "5d6b881a-bcff-4e92-84bc-935578fdb8d9","name": "Flour", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "709364bc-514e-4559-a8ec-ea71468dc891","name": "Sugar", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "ec91d02e-e3f6-485e-b833-736251b98460","name": "Rice", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "71f878bb-a083-41d8-b81c-8b3b2abf6e9d","name": "Pasta", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "0540f760-856d-455b-b8cc-ea7959723c19","name": "Ground Beef", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "f1fe8e4c-494e-42c1-9db0-7ad42a28bfee","name": "Salmon", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "60c5638c-28fa-4b5e-976a-11c6de1ab517","name": "Spinach", "units": ["kg", "g", "pcs", "slice"]},
    ...
    {"id": "9749559b-1b4b-483c-897b-96bd1aaa26ec","name": "Yogurt", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "4220b200-ef4c-485a-8c07-12d57bdf1688","name": "Quinoa", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "8d86aff1-8f8d-4c9b-8cb4-306b942e283b","name": "Chickpeas", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "5af9acd5-5f52-46f2-b717-01f76a0be253","name": "Coconut Milk", "units": ["kg", "g", "pcs", "slice"]},
    ...
    {"id": "87dccb5b-5262-4b27-b292-0f3bc0ea915a","name": "Cilantro", "units": ["kg", "g", "pcs", "slice"]},
    ...
    {"id": "17015c7b-e74d-4774-afe9-0dd5cb837bed", "name": "Almonds", "units": ["kg", "g", "pcs", "slice"]},
    {"id": "6162fa94-f602-4376-9659-f87433bca77e", "name": "Honey", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"0d105985-1449-480f-8a59-a28b1a842f3c","name":"Shrimp", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"c88c52ba-2534-40e4-8d49-3b0860df4649","name":"Lentils", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"678754a1-100d-4cef-ace6-2d66f80fe67e","name":"Tofu", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"5c92d401-9ee4-4940-9b73-86fa01228d4a","name":"Arugula", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"4c102109-1ee9-43c5-9e88-bacf0e668d0d","name":"Parmesan Cheese", "units": ["kg", "g", "pcs", "slice"]},
    ...
    {"id":"e2e91854-f8ca-427f-9b32-e18fd2a48498","name":"Cucumber", "units": ["kg", "g", "pcs", "slice"]},
    ...
    {"id":"cb232181-c09f-4dc0-90fe-246ec3a8dad3","name":"Pine Nuts", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"1b3391c1-2f8b-49f8-a0d1-f876f1ed15f5","name":"Ginger", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"9bd72cef-87e4-4108-a047-e3df0529eee9","name":"Soy Sauce", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"008340ad-18b2-4ed8-9eab-da78f798910d","name":"Jalapeno", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"ca0aa585-83cd-496f-b04b-5578e131f293","name":"Mango", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"c261d725-4f92-4bb5-a150-0da24d7a520b","name":"Panko Breadcrumbs", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"a1fc11e8-6c74-4e1a-95a6-654f4c96bcf8","name":"Ricotta Cheese", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"58564747-90f7-4053-bf00-599fe78dfa96","name":"Artichoke Hearts", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"9266dcfa-f2c0-4ea5-a6d4-303297476cc4","name":"Sun-Dried Tomatoes", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"8da402f8-94e1-4387-9468-c6b7cfcbf460","name":"Blueberries", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"c4e88c03-7fef-4d55-b9b9-3a3a79d1ba83","name":"Hazelnuts", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"31d3c9c1-2bca-4db6-8e6e-68a2e079938d","name":"Prosciutto", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"414c6e0a-6b4b-4a47-9424-2589544c0985","name":"Kale", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"397a895b-3fe7-40a7-847c-ff5cebbceb4c","name":"Sriracha Sauce", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"7bd2d809-c73e-4b12-ad13-398b5a0235f8","name":"Tahini", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"21b74ccf-3fa4-4de2-959e-5bed5f5469de","name":"Edamame", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"69a2dbee-7de7-4514-9f3a-4012fea5d5a3","name":"Seaweed Sheets", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"7ebd8830-e505-4ed4-8fff-0a35d306e377","name":"Butternut Squash", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"42b87fca-1db3-4666-8eff-f622cd40e0f7","name":"Farro", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"d0156778-ad53-4edf-8292-2e114234573b","name":"Halloumi Cheese", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"18d709a8-a642-4ddf-9734-5b22c02cfa3e","name":"Kimchi", "units": ["kg", "g", "pcs", "slice"]},
    {"id":"ee6611b2-a656-4c16-b938-ccede9148216","name":"Gochujang", "units": ["kg", "g", "pcs", "slice"]},
