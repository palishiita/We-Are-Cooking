...
use crate::model::{HealthResponse, PostReel, PostVideo, Reel, ReelWithVideos, ReelWithVideosForm, Video, VideoForm};
...
#[openapi(
    ...
    components(schemas(HealthResponse, Reel, PostReel, Video, PostVideo, VideoForm, ReelWithVideos, ReelWithVideosForm))
)]
pub struct ApiDoc;
